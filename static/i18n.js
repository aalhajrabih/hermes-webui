...
const LOCALES = {
  ...
  ar: {
    ...
    mcp_field_timeout: 'المهلة (ثواني)',
    mcp_save: 'حفظ',
    mcp_cancel: 'إلغاء',
    ...
    mcp_delete_confirm_message: 'حذف خادم MCP "{0}"؟ لا يمكن التراجع.',
    ...
    mcp_status_active: 'نشط',
    mcp_status_configured: 'مُعدّ',
    mcp_status_disabled: 'معطّل',
    mcp_status_invalid_config: 'إعداد غير صالح',
    mcp_status_unknown: 'غير معروف',
    mcp_tool_count: '{0} أدوات',
    mcp_enabled_yes: 'مفعّل',
    mcp_enabled_no: 'معطّل',
    mcp_enable_server: 'تفعيل خادم MCP هذا',
    mcp_disable_server: 'تعطيل خادم MCP هذا',
    mcp_enabled_toast: (name) => `خادم MCP "${name}" مفعّل.`,
    mcp_disabled_toast: (name) => `خادم MCP "${name}" معطّل.`,
    mcp_toggle_failed: 'فشل تحديث خادم MCP.',
    ...
    mcp_tools_no_tools: 'لا توجد أدوات MCP متاحة من الجرد النشط.',
    mcp_tools_no_matches: 'لا توجد أدوات MCP تطابق بحثك.',
    ...
    settings_label_auxiliary_models: 'النماذج المساعدة',
    settings_desc_auxiliary_models: 'توجيه المهام الجانبية للرؤية والضغط وتوليد العناوين. تلقائي يستخدم نموذجك الرئيسي.',
    settings_btn_reset_aux_models: 'إعادة تعيين الكل إلى تلقائي',
    settings_btn_apply_aux_models: 'تطبيق التغييرات',
    settings_aux_provider_auto: 'استخدام النموذج الرئيسي',
    settings_aux_model_auto: 'تلقائي (استخدام افتراضي المزوّد)',
    settings_aux_model_custom: 'نموذج مخصص…',
    settings_aux_model_custom_prompt: 'أدخل معرف النموذج:',
    settings_aux_loading: 'جارٍ تحميل النماذج المساعدة…',
    settings_aux_load_failed: 'فشل تحميل إعدادات النماذج المساعدة.',
    settings_aux_reset_confirm_title: 'إعادة تعيين النماذج المساعدة؟',
    settings_aux_reset_confirm_msg: 'هذا سيعيد جميع المهام المساعدة إلى تلقائي.',
    settings_aux_reset_done: 'تمت إعادة تعيين النماذج المساعدة إلى تلقائي',
    settings_aux_save_failed: 'فشل حفظ النموذج المساعد',
    settings_aux_saved: 'تم تحديث النماذج المساعدة',
    settings_aux_no_changes: 'لا توجد تغييرات للتطبيق',
    ...
    settings_label_ignore_agent_updates: 'تجاهل تحديثات الوكيل',
    ...
    settings_desc_ignore_agent_updates: 'إبقاء فحص تحديثات WebUI، لكن إخفاء إشعارات تحديث الوكيل.',
    ...
    settings_label_shutdown: 'إيقاف خادم Hermes WebUI',
    settings_desc_shutdown: 'إيقاف خادم WebUI المحلي بلطف. مفيد إذا شغّلته عبر <code>./ctl.sh start</code>.',
    settings_btn_shutdown: 'إيقاف الخادم',
    settings_shutdown_confirm_title: 'إيقاف Hermes WebUI',
    settings_shutdown_confirm_message: 'إيقاف خادم Hermes WebUI؟',
    settings_shutdown_confirm_btn: 'إيقاف',
    settings_shutdown_stopped_message: 'تم إيقاف الخادم. يمكنك إغلاق هذا التبويب.',
    ...
    external_notes_sources: 'ملاحظات خارجية',
    external_notes_empty: 'لا توجد مصادر ملاحظات MCP مرئية بعد.',
    external_notes_auto_recall_hint: 'الاستدعاء التلقائي للجلسة لم يتغير.',
    external_notes_no_tools: 'لا توجد أدوات قراءة/بحث متاحة لهذا المصدر حالياً.',
    external_notes_tool_count: (count) => `${count} أداة ملاحظات متاحة`,
    external_notes_configured_hint: 'أسماء الأدوات متوقعة من هذا المصدر المُعدّ.',
    external_notes_recent_ai: 'استخدمها الذكاء الاصطناعي مؤخراً',
    external_notes_auto: 'تلقائي',
    external_notes_recent_ai_reason: 'استدعاء تلقائي',
    external_notes_search_placeholder: 'ابحث في الملاحظات…',
    external_notes_search_empty: 'ابحث في مصدر ملاحظات لمعاينة الملاحظات هنا.',
    source_active: 'نشط',
    source_configured: 'مُعدّ',
    ...
    cron_deliver_custom: 'هدف توصيل مخصص',
    ...
    checkpoint_diff_files_changed: '{0} ملفات متغيرة',    session_toolsets: 'مجموعات أدوات الجلسة',
    session_toolsets_desc: 'تقييد الأدوات المتاحة لهذه الجلسة (فارغ = استخدام الإعداد العام)',
    session_toolsets_global: 'عام (افتراضي)',
    session_toolsets_custom: 'مخصص',
    session_toolsets_placeholder: 'أداة1, أداة2, …',
    session_toolsets_apply: 'تطبيق',
    session_toolsets_clear: 'مسح (استخدام العام)',
    session_toolsets_applied: 'تم تحديث مجموعات الأدوات',
    session_toolsets_cleared: 'تم مسح مجموعات الأدوات — استخدام الإعداد العام',
    session_toolsets_failed: 'فشل تحديث مجموعات الأدوات: ',
    usage_personality_none: 'بدون',

    cmd_help: 'تعليمات',
    cmd_use: 'استخدام',
    composer_compression_will_queue: 'سيُضبط إرسالك مؤقتاً أثناء معالجة المهام السابقة',
    cron_view_full_output: 'عرض كامل المخرجات',
    default: 'افتراضي',
    gateway_auth_label: 'مصادقة البوابة',
    insights_skill_usage_col_patches: 'تعديلات',
    insights_skill_usage_col_share: 'نسبة',
    insights_skill_usage_col_skill: 'المهارة',
    insights_skill_usage_col_uses: 'استخدامات',
    insights_skill_usage_col_views: 'مشاهدات',
    insights_skill_usage_footer: 'تنزيل CSV',
    insights_skill_usage_no_data: 'لا توجد بيانات',
    insights_skill_usage_no_data_hint: 'لم تُسجل أي استخدامات للمهارات بعد',
    insights_skill_usage_skills_used: 'مهارات مستخدمة',
    insights_skill_usage_sub: 'تحليل استخدام المهارات عبر كل الجلسات',
    insights_skill_usage_title: 'المهارات',
    insights_skill_usage_total: 'المجموع',
    media_download: 'تحميل الوسائط',
    model_did_you_mean: 'هل تقصد',
    move_failed: 'فشل النقل',
    moved_to: 'نُقل إلى',
    plugins_enable_toggle: 'تفعيل/تعطيل',
    providers_models_refreshed: 'تم تحديث قائمة النماذج',
    providers_refresh_models: 'تحديث النماذج',
    providers_refreshing: 'جاري التحديث...',
    search: 'بحث',
    session_attention_approval: 'طلب موافقة',
    session_attention_approval_title: 'بالموافقة',
    session_attention_clarify: 'طلب توضيح',
    session_attention_clarify_title: 'بتوضيح',
    session_attention_generic: 'طلب انتباه',
    session_attention_generic_title: 'بانتباه',
    session_child_toggle_hint: 'إظهار/إخفاء الجلسات الفرعية',
    session_copy_link: 'نسخ رابط الجلسة',
    session_copy_link_desc: 'نسخ رابط قابل للمشاركة لهذه الجلسة',
    session_lineage_static_hint: 'شجرة محادثات ثابتة — غير متاحة للتحرير',
    session_lineage_toggle_hint: 'إظهار/إخفاء شجرة المحادثات',
    session_link_copied: 'تم نسخ الرابط',
    session_link_copy_failed: 'فشل نسخ الرابط',
    session_readonly_title_hint: 'عنوان للقراءة فقط',
    session_rename_failed_no_row: 'فشلت إعادة التسمية — الجلسة غير موجودة',
    session_status_click_to_change: 'اضغط لتغيير الحالة',
    session_status_done: 'مكتمل',
    session_status_in_progress: 'قيد التنفيذ',
    session_status_todo: 'للعمل',
    session_title_regenerate: 'إعادة إنشاء العنوان',
    session_title_regenerate_desc: 'اطلب من الذكاء الاصطناعي تلخيص هذه المحادثة في عنوان',
    session_title_regenerate_failed: 'فشل إعادة إنشاء العنوان',
    session_title_regenerated: 'تم تحديث العنوان',
    session_title_regenerating: 'جاري إنشاء العنوان...',
    session_toolsets: 'مجموعات الأدوات',
    settings_desc_activity_feed_expanded_default: 'إظهار لوحة النشاط موسعة عند بدء الجلسة',
    settings_desc_cron_sessions: 'إظهار جلسات المهام المجدولة في الشريط الجانبي',
    settings_desc_raw_audio: 'عند التفعيل، التسجيلات الصوتية تُرسل كملفات خام بدون تحويل للنص أولاً',
    settings_desc_tts_engine: 'محرك تحويل النص إلى كلام',
    settings_label_activity_feed_expanded_default: 'لوحة النشاط موسعة افتراضياً',
    settings_label_cron_sessions: 'جلسات المهام المجدولة',
    settings_label_raw_audio: 'صوت خام',
    settings_label_tts_engine: 'محرك الصوت',
    uploaded: 'تم الرفع',
    uploading: 'جاري الرفع...',
    voice_raw_attached: '🎤 مرفق صوتي خام',
    voice_recording_active: '🎤 جاري التسجيل... اضغط للإيقاف',
    voice_send_raw: 'إرسال الصوت الخام',
 ...
 * @param {string} lang
 */
// RTL languages — auto-enable .chat-content-rtl unless the user has
// explicitly toggled the RTL checkbox before (hermes-rtl-touched).
...
function setLocale(lang) {
  ...
  const rtlTouched = localStorage.getItem('hermes-rtl-touched') === 'true';
  if (!rtlTouched) {
    const shouldRtl = RTL_LOCALES.has(resolved);
    try { localStorage.setItem('hermes-rtl', shouldRtl ? 'true' : 'false'); } catch (_) {}
    document.documentElement.classList.toggle('chat-content-rtl', shouldRtl);
  }
}
